...
public abstract class PlusBaseActivity extends Activity
    ...
    private GoogleApiClient mGoogleApiClientt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mGoogleApiClientt = new GoogleApiClient.Builder(this)
                .addApi(Plus.API)
     ...
     */
    public void signIn() {
        if (!mGoogleApiClientt.isConnected()) {
    ...
    private void initiatePlusClientConnect() {
        if (!mGoogleApiClientt.isConnected() && !mGoogleApiClientt.isConnecting()) {
            mGoogleApiClientt.connect();
        }
    }
    ...
    public void signOut() {
        ...
        if (mGoogleApiClientt.isConnected()) {
            ...
            mGoogleApiClientt.clearDefaultAccountAndReconnect();
    ...
    public void revokeAccess() {
        ...
        if (mGoogleApiClientt.isConnected()) {
            ...
            /**
             ...
             mGoogleApiClientt.(new GoogleApiClient.OnAccessRevokedListener() {
    ...
    public GoogleApiClient getmGoogleApiClientt() {
        return mGoogleApiClientt;
    }
